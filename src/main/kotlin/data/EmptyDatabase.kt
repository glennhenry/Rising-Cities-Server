...
class EmptyDatabase : Database {
    override suspend fun loadPlayerAccount(userId: String): PlayerAccount = TODO("ONLY TEST")
    override suspend fun loadPlayerData(userId: String): PlayerData = TODO("ONLY TEST")
